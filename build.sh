...
# Menu-bar template glyph — our own mark, generated by design/icon.swift so it
# cannot drift from the app icon. Flat in Resources/ so NSImage(named:) finds it.
cp Resources/MenuBar/*.png "$BUNDLE/Contents/Resources/"
